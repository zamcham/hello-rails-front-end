...
## Hello-react-front-end - Your Budget App!

This is the front end of an app that displays a random greeting

[Click here to check the Rails API App](https://github.com/zamcham/hello-rails-back-end)
...
```sh
  cd my-folder
  git clone https://github.com/zamcham/hello-rails-front-end
```
...
run server (note: after you run the back end server)
...
Thank you to the Microverse team.
